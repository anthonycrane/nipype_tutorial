...
# Timestamp: 2018-05-22 21:52:09 UTC
# 
...
RUN bash -c 'source activate neuro && cd /home/neuro/data && datalad install -r ///workshops/nih-2017/ds000114 && cd ds000114 && datalad update -r && datalad get -r sub-01/ses-test/anat sub-01/ses-test/func/*fingerfootlips*'
